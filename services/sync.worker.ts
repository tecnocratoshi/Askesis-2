...
function jsonReviver(key: string, value: any) {
    // REPAIR [2025-06-05]: Direct support for hex strings often generated by HabitService serialization
...
self.onmessage = async (e) => {
    ...
    try {
        ...
        switch (type) {
            ...
            // --- FIX: Corrected function call name to match the defined buildAiQuoteAnalysisPrompt ---
